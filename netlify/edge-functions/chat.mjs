...
If — and only if — the chart is a two-bar before/after or without/with comparison, add the exact bare attribute data-sentiment="down" to the lower/"before" bar's <g data-bar-group>, and data-sentiment="up" to the higher/"after" bar's <g data-bar-group> — nothing else, no icon or extra markup of your own. The host places a face icon precisely inside each of those two bars automatically once it's grown in. Skip both attributes entirely for any chart with more than two bars or that isn't a before/after comparison.
...
<div>
  ...
  <div class="not-prose">
    <svg viewBox="0 0 400 220" class="w-full">
      ...
      <g data-bar-group data-sentiment="down">
